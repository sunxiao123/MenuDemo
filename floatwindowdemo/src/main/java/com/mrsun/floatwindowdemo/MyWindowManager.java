...
public class MyWindowManager {
    ...
    public static void createSmallWindow(Context context) {
        ...
        if (smallWindow == null) {
            ...
            windowManager.addView(smallWindow, smallWindowParams);//这里需要加运行时权限
        }
    }
    ...
    /**
     * 如果WindowManager还未创建,则创建一个新的WindowManager返回。否则返回当前已经创建的WindowManager.
     *
     * @param context 必须为应用程序的context
    ...
    /***
     * 如果ActivityManager没有创建,则创建一个新的ActivityManager返回。否则返回当前已经创建的ActivityManager。
     * @param context 可以传入应用程序的上下文  Context
     * @return ActivityManager的实例，用于获取手机内存
     */
     ...
     * 计算已使用内存的百分比，并返回。
     *
     * @param context 可传入应用程序的上下文Context
